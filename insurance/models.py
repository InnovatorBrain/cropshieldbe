...
class PolicyApplication(models.Model):
    ...
    cropsInsured = models.CharField(max_length=255, choices=CROP_CHOICES, null=True, blank=True)
    otherCrop = models.CharField(max_length=255, null=True, blank=True)
    acreagePlanted = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    cropVariety = models.CharField(max_length=255, null=True, blank=True)
    plantingDate = models.DateField(null=True, blank=True)
    ...
    selectPolicy = models.CharField(max_length=255, choices=POLICY_CHOICES, null=True, blank=True)
    coverageAmount = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    ...
    riskFactor = models.CharField(max_length=255, choices=RISK_FACTOR_CHOICES, null=True, blank=True)
    ...
    paymentMethod = models.CharField(max_length=20, choices=PAYMENT_METHOD_CHOICES, null=True, blank=True)
